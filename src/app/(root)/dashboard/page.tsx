    ...
    <section className="w-full min-h-screen lg:p-4">
      ...
      <div className="max-w-4xl mx-auto ">
        <div className="text-justify space-y-4">
          ...
          <div>
            <span className="font-semibold text-md">Diseñado pensando en los usuarios</span><br/>
            <p className='pt-1 '>
          ...
          <p>
            <span className="font-semibold pt-1">Construido para desarrolladores</span><br/>
          ...
          <p>
            <span className="font-semibold pt-1">Totalmente personalizable</span><br/>
